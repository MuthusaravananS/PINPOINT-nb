...
INPUT_FOLDER = Path(r"C:\Users\91830\Desktop\classfier_pfeature\protfeat\pos_comp_feat")
OUTPUT_FOLDER = Path(r"C:\Users\91830\Desktop\classfier_pfeature\protfeat\pos_compfeat_extraction_output")
FASTA_NAME = "PIs_positive_cleaned"
FEATURES = ["AAC", "GDPC", "PAAC", "DPC", "GAAC"]
OUTPUT_FILE = "PIs_corre_feat.csv"
